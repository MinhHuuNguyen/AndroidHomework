...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_send) {
            changeFragment(new PaymentSuccessfullFragment(), true);
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch(id) {
            case R.id.nav_article:
                changeFragment(new NewItemFragment(), true);
                break;
            case R.id.nav_payment:
                changeFragment(new NewPaymentFragment(), true);
                break;
    ...
    private void changeFragment(android.support.v4.app.Fragment fragment, boolean addToBackstck){
